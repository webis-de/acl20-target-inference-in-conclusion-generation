...
class OnlineTargetTripletLoss(nn.Module):
    """
    ...
    def forward(self, embeddings, target):
        ...
        distance_positive = self.distance(embeddings[triplets[:, 0]], embeddings[triplets[:, 1]])
        distance_negative = self.distance(embeddings[triplets[:, 0]], embeddings[triplets[:, 2]])
